...
import {
	FormRefObject,
	ValidatedForm,
} from "src/app/components/form/ValidatedForm";
...
import { updateProduct } from "./product.reducer";
...
const ProductEditForm = () => {
	...
	const { product, showDialog, status } = useAppSelector(
		(state) => state.productManagement.selectedProduct
	);
	...
	return (
		<ValidatedForm
			...
			defaultValues={{ ...product, allergens: product.allergens || "" }}>
